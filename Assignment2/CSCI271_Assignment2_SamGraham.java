...
*
* Purpose:
* Implements a Fraction class with exact arithmetic operations. Fractions
* are stored in reduced, normalized form. Special cases for Infinity, 
* -Infinity, and NaN are handled. This version includes rigorous test cases.
*
*************************************************************************/
...
* - I have not used programming code from unauthorized sources.
* - Any external sources used are properly cited.
********************************************************************/
...
public class CSCI271_Assignment2_SamGraham {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test 1.4: new Fraction(-12, -3) // expect 4");
        System.out.println(new Fraction(-12, -3));

        System.out.println("Test 1.5: new Fraction(0, 1)    // expect 0");
        ...
        System.out.println("Test 2.5: new Fraction(10, 5)   // expect 2");
        System.out.println(new Fraction(10, 5));
        ...
        System.out.println("Test 3.5: 0/1 + 5/7             // expect 5/7");
        System.out.println(new Fraction(0, 1).add(new Fraction(5, 7)));

        System.out.println("Test 3.6: -1/2 + 1/2            // expect 0");
        System.out.println(new Fraction(-1, 2).add(new Fraction(1, 2)));

        System.out.println("Test 3.7: 5/7 - 5/7             // expect 0");
        System.out.println(new Fraction(5, 7).subtract(new Fraction(5, 7)));
        ...
        System.out.println(new Fraction(1, 0).negate());

        System.out.println("Test 4.3: negate(NaN)           // expect NaN");
        System.out.println(new Fraction(0, 0).negate());

        System.out.println("Test 4.4: negate(-2/3)          // expect 2/3");
        System.out.println(new Fraction(-2, 3).negate());
        ...
        System.out.println("Test 5.4: (-2/3)^3              // expect -8/27");
        System.out.println(new Fraction(-2, 3).pow(3));

        System.out.println("Test 5.5: (4/5)^1               // expect 4/5");
        System.out.println(new Fraction(4, 5).pow(1));
        ...
        System.out.println(c.multiply(a.divide(b)));

        // Additional edge tests for bounds
        System.out.println("\n===== Additional Edge Cases =====");
        System.out.println("Test E1: 0/3 * 5/7              // expect 0");
        System.out.println(new Fraction(0, 3).multiply(new Fraction(5, 7)));

        System.out.println("Test E2: 5/0 + 3/4              // expect Infinity");
        System.out.println(new Fraction(5, 0).add(new Fraction(3, 4)));

        System.out.println("Test E3: -5/0 + -2/7            // expect -Infinity");
        System.out.println(new Fraction(-5, 0).add(new Fraction(-2, 7)));
    }
}
...
class Fraction {
    ...
    public Fraction pow(int n) {
        ...
        if (n < 0) return new Fraction(denominator, numerator).pow(-n);
